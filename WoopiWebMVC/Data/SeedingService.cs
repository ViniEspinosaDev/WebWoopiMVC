...
using System;
using WoopiWebMVC.Models.Enums;

namespace WoopiWebMVC.Data
{
    public class SeedingService
    {
        private WoopiWebMVCContext _context;

        public SeedingService(WoopiWebMVCContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 3, 1), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(2000, 12, 24), 3000.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1996, 11, 15), 1500.0, d4);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1988, 10, 09), 19900.0, d3);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1970, 2, 27), 5000.0, d2);
            Seller s6 = new Seller(6, "Alex Pink", "pink@gmail.com", new DateTime(1979, 6, 13), 7000.0, d1);
